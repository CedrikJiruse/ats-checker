...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=int,
        help="Number of resume versions to generate per job description.",
    )
    parser.add_argument(
        "--model_name", type=str, help="Name of the generative AI model to use."
    )
    parser.add_argument(
        "--temperature", type=float, help="Controls the randomness of the output."
    )
    parser.add_argument(
        "--top_p",
        type=float,
        help="The maximum cumulative probability of tokens to consider.",
    )
    parser.add_argument(
        "--top_k", type=int, help="The maximum number of tokens to consider."
    )
    parser.add_argument(
        "--max_output_tokens",
        type=int,
    ...
    parser.add_argument(
        ...
        type=str,
        help="Folder containing input resume JSON files.",
    )
    parser.add_argument(
