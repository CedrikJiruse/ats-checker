...
#[command(version)]
#[command(about = "ATS Resume Checker - Enhance resumes using AI and score them against job descriptions")]
#[command(long_about = "ATS Resume Checker is a powerful tool that uses AI to enhance resumes and score them \
...
pub struct Cli {
    ...
    #[arg(long_help = "Path to the TOML configuration file containing API keys, paths, and processing settings.\n\
...
pub enum Commands {
    ...
    #[command(long_about = "Analyzes a resume file and calculates a comprehensive quality score based on \
    ...
    ScoreResume {
        ...
        #[arg(long_help = "Path to the resume file in JSON or TOML format. This should be an \
        ...
        #[arg(long_help = "Optional path to a TOML file with custom scoring weights. \
    ...
    #[command(long_about = "Analyzes the compatibility between a resume and a job description. \
    ...
    ScoreMatch {
        ...
        #[arg(long_help = "Path to the job description file. Can be TXT, MD, or any text-based format. \
    ...
    #[command(long_about = "Analyzes job postings from a search results file and ranks them by quality score. \
    ...
    #[command(long_about = "Search for jobs using the JobSpy library integration. Supports LinkedIn, Indeed, \
    ...
    JobSearch {
        ...
        #[arg(long_help = "Comma-separated list of job sources to search. Available sources:\n  \
