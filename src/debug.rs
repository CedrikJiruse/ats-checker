...
/// Log debug message to file - only when `debug` feature is enabled
#[macro_export]
macro_rules! debug {
    ($($arg:tt)*) => {
        #[cfg(feature = "debug")]
...
/// Log debug message without newline - only when `debug` feature is enabled
#[macro_export]
...
/// Log section header - only when `debug` feature is enabled
#[macro_export]
...
/// Log subsection - only when `debug` feature is enabled
#[macro_export]
...
/// Log function entry - only when `debug` feature is enabled
#[macro_export]
...
/// Log function exit - only when `debug` feature is enabled
#[macro_export]
...
/// Log variable dump - only when `debug` feature is enabled
#[macro_export]
